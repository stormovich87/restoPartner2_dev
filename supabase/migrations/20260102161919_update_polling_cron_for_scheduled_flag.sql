/*
  # Update polling cron to use is_scheduled flag

  1. Changes
    - Update send_scheduled_courier_polls to check only scheduled polls
    - Set is_scheduled = true for automatic polls
    - This allows manual and automatic polls on the same day
*/
