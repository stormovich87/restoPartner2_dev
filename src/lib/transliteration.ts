...
/**
 * Generates a URL-safe slug from name and lastname
 * Converts Cyrillic to Latin and formats as lowercase with hyphens
 */
...
/**
 * Generates a full cabinet URL based on courier slug (public route)
 */
